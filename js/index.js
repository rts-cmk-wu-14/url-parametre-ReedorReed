...
function content(destinations) {
            ...
            <figure class="card">
                ...
                <figcaption class="card__description">
                    ...
                    <div class="card__favorite">
                        <div class="card__favoriteHeart" data-id="${destination.id}">
                                <svg class="card__favorite-btn clickBtn" width="35" height="32" viewBox="0 0 35 32" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	createLocalStorage(hearts, 'myFavorites', true);
	handleHeart(hearts);
	updateHeartDom('myFavorites', hearts);
}
