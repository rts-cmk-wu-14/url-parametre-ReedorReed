    ...
    <section class="details">
        <figure>
            ...
            <div class="details__favorite-btn">
                <div class="card__favoriteHeart" data-id="${data.id}">
                    <svg class="details__heart-icon clickBtn" width="35" height="32" viewBox="0 0 35 32" fill="none" xmlns="http://www.w3.org/2000/svg">
